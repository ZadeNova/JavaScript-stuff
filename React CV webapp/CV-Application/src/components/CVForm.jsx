...
function Form( { personalInfoFormData , onPersonalInfoDataChange}) {
		...
		<>
			<h1 style={{textAlign : "center"}}>CV Form</h1>
				...
				<fieldset>
					...
					<input type="text" id="phoneNum" name="phoneNum" value={phoneNumber} onChange={handlePhoneNumChange}></input>
				...
				<fieldset>
					...
					<input type="text" id="schoolName" name="schoolName" value={schoolName} onChange={handleSchoolNameChange}></input>

					<label htmlFor="certName">Program/Degree/Diploma/Course</label>
					<input type="text" id="certName" name="certName" value={qualification} onChange={handleQualificationChange}></input>

					<label htmlFor="startDate">Start Date</label>
					<input type="date" id="startDate" name="startDate" value={startDate} onChange={handlestartDateChange}></input>

					<label htmlFor="onGoing">On-Going</label>
					<input type="checkbox" id="onGoing" name="onGoing" checked={isChecked} onChange={handleCheckboxChange}></input>

					{isChecked === true && 
					<>
					<label htmlFor="endDate">End Date</label>
					<input type="date" id="endDate" name="endDate" value={endDate} onChange={handleendDateChange}></input>
					</>}
				...
				<fieldset>
					...
					<input type="text" id="jobTitle" name="jobTitle" value={jobTitle} onChange={handlejobTitleChange}></input>

					<label htmlFor="companyName">Company/Organisation</label>
					<input type="text" id="companyName" name="companyName" value={companyName} onChange={handleCompanyChange}></input>


					<label htmlFor="jobstartDate">Starting Date</label>
					<input type="date" id="jobstartDate" name="jobstartDate" value={jobstartDate} onChange={handlejobstartDate}></input>

					<label htmlFor="onGoingJob">On-Going</label>
					<input type="checkbox" id="onGoingJob" name="onGoingJob" checked={isCheckedJob} onChange={handleJobCheckboxChange}></input>

					{isCheckedJob === true && 
					<>
						<label htmlFor="endDateJob">End Date</label>
						<input type="date" id="endDateJob" name="endDateJob" value={jobendDate} onChange={handlejobendDate}></input>
					...
					<input type="text" id="jobResponsibilities" name="jobResponsibilities" value={jobResponsibilities} onChange={handleJobResponsibilities}></input> 
				...
				<fieldset>
					...
					<input type="text" id="skills" name="skills" value={skills} onChange={handleSkillsChange}></input> 
				</fieldset>
